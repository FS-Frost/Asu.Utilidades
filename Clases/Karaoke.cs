    ...
    public class Karaoke {
        ...
        private List<Silaba> FiltrarSilabas(List<string> elementos) {
            ...
            for (var i = 0; i < elementos.Count; i++) {
                ...
                if (FiltroAss.EsGrupoTag(elementoActual)) {
                    // Si es grupo {}.
                    silaba.GrupoTag = new GrupoTag(elementoActual);
                } else {
                    // Si es texto.
        ...
        public void AgregarSilaba(int duracion, string texto, TiposKaraoke tipoKaraoke) {
        ...
        public void AgregarSilaba(int tiempo, string texto, TiposKaraoke tipoKaraoke, GrupoTag grupoTag) {
        ...
        public void Normalizar(TiposKaraoke tipo) {
            Silabas.ForEach(x => {
                x.Tipo = tipo;
            });
        }
