...
namespace Asu.Utilidades {
    ...
    public static class Karaokes {
        ...
        public static Karaoke DividirSilabas(Linea linea) {
            // Karaoke resultante.
            ...
            for (var i = 0; i < palabras.Count; i++) {
                ...
                if (EsRomaji(palabra)) {
                    var regex = new Regex(ExpresionesRegulares.regexRomaji);
                    var matches = regex.Matches(palabra);

                    foreach (Match match in matches) {
                        karaoke.AgregarSilaba(0, match.Value, TiposKaraoke.Kf);
                    }
                } else {
                    // Si no es romaji, se agrega completa.
                    karaoke.AgregarSilaba(0, palabra, TiposKaraoke.Kf);
                }
        ...
        public static bool EsRomaji(string texto) {
            var regex = new Regex(ExpresionesRegulares.regexRomaji);
        ...
        public static List<Linea> DividirKaraoke(Linea lineaKaraoke, int indice) {
            ...
            // Generando tiempo.
            var tiempo1 = new Tiempo(tiempo1Double);
            ...
            // Generando tiempo.
            var tiempo2 = new Tiempo(tiempo2Double);
        ...
        public static List<Linea> DividirKaraoke(Linea lineaKaraoke, int[] indices) {
            ...
            for (var i = 0; i < indicesOrdenados.Length; i++) {
                ...
                lineasDivididas = DividirKaraoke(dividiendo, finPrimera);
