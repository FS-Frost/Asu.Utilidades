...
namespace Asu.Utilidades.Clases.ArchivoASS {
    ...
    public class ArchivoASS {
        ...
        public string Ruta {
            get {
                return Path.Combine(Directorio, Nombre + Extension);
            }
        }
        ...
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="ArchivoASS"/> al leer un archivo ASS.
        /// </summary>
        /// <param name="ruta">Ruta del archivo ASS.</param>
        public ArchivoASS(string ruta) {
            ...
            Directorio = Path.GetDirectoryName(ruta);
            ...
            List<string> lineas;
            try {
                lineas = File.ReadAllLines(ruta, Encoding.ASCII).ToList();
            } catch (Exception) {
                throw;
            }
            ...
            for (var i = 0; i < lineas.Count; i++) {
                ...
                if (scriptInfoActivo) {
                    ...
                    if (lineaActual.StartsWith(_WrapStyle)) {
                        ScriptInfo.WrapStyle = WrapStylesInfo.StringToWrapStyle(lineaActual.Substring(_WrapStyle.Length));
                    } else
                    ...
                    if (lineaActual.StartsWith(_YCbCrMatrix)) {
                        ScriptInfo.YCbCrMatrix = YCbCrMatricesInfo.StringToYCbCrMatrix(lineaActual.Substring(_YCbCrMatrix.Length));
                    } else
        ...
        /// <summary>
        /// Devuelve una instancia de <see cref="ArchivoASS"/> dada una ruta de acceso a un archivo ASS.
        /// </summary>
        /// <param name="ruta">Ruta del archivo ASS.</param>
        /// <returns></returns>
        public static ArchivoASS Abrir(string ruta) {
            return new ArchivoASS(ruta);
        }
        ...
        public void Guardar(bool sobrescribir) {
            ...
            File.WriteAllText(Ruta, ToString());
        }
